...
fn glPointSizePointerOES(_env: &mut Environment, type_: GLenum, stride: GLsizei, _pointer: ConstVoidPtr) { log_once!("glPointSizePointerOES(type: {:#x}, stride: {}) — stubbed", type_, stride); }
...
fn glGetTexParameteriv(_env: &mut Environment, type_: GLenum, stride: GLsizei, _pointer: ConstVoidPtr) {}
